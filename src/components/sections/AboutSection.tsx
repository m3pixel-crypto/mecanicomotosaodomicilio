...
export const AboutSection = () => {
  return <section id="sobre" className="py-20 bg-secondary">
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground text-lg">
            Desde 2008, Jorge Miguel dedica-se a cuidar das motas dos nossos clientes com a mesma atenção que damos às nossas. O seu mecânico de motos a um clique de distância. Manutenção com transparência no conforto da sua casa. Otimize o seu dia, conveniência de serviço em casa. Conheça o futuro da manutenção das duas rodas!   
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => <div key={index} className="bg-card rounded-xl p-6 shadow-elegant hover:shadow-elegant-lg transition-all duration-300 group">
