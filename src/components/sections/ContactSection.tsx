      ...
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground text-lg">
            Estamos prontos para ajudar. Nós trazemos a oficina até a sua porta. Saiba como funciona este serviço revolucionário em apenas 3 cliques: ligue ou envie uma mensagem.

Diga adeus à complicação de levar a moto à oficina. Acreditamos que a manutenção deve ser tão fluida quanto o seu passeio.
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="aspect-video rounded-xl overflow-hidden shadow-elegant-lg">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d194347.38440514498!2d-9.229838823828124!3d38.73664015!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd1933a24aa81f17%3A0x400ebbde4903420!2sLisboa!5e0!3m2!1spt-PT!2spt!4v1699999999999!5m2!1spt-PT!2spt" width="100%" height="100%" style={{
              border: 0
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  ...formData,
                  name: e.target.value
                })} className={`w-full px-4 py-3 rounded-lg border bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-accent transition-shadow ${errors.name ? "border-destructive" : "border-input"}`} placeholder="O seu nome" />
                ...
                })} className={`w-full px-4 py-3 rounded-lg border bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-accent transition-shadow ${errors.phone ? "border-destructive" : "border-input"}`} placeholder="+351 912 345 678" />
              ...
              })} className={`w-full px-4 py-3 rounded-lg border bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-accent transition-shadow ${errors.email ? "border-destructive" : "border-input"}`} placeholder="o.seu@email.com" />
              ...
              })} className={`w-full px-4 py-3 rounded-lg border bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-accent transition-shadow ${errors.service ? "border-destructive" : "border-input"}`}>
              ...
              })} rows={4} className={`w-full px-4 py-3 rounded-lg border bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-accent transition-shadow resize-none ${errors.message ? "border-destructive" : "border-input"}`} placeholder="Descreva o que precisa..." />
